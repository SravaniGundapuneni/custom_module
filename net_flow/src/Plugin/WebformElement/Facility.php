...
/**
 * Provides a 'Facility' element.
 *
 * @WebformElement(
 *   id = "facility",
 *   label = @Translation("Facility element"),
 *   description = @Translation("Provides a Facility element listing facilities based on Medical Areas."),
 ...
 */
class Facility extends WebformElementBase {
