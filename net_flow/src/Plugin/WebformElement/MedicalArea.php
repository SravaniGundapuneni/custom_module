...
/**
 * Provides a 'MedicalArea' element.
 *
 * @WebformElement(
 *   id = "medicalarea",
 *   label = @Translation("Medical Area element"),
 *   description = @Translation("Provides a Medical Area element listing all medical areas in KP network."),
 ...
 */
class MedicalArea extends WebformElementBase {
