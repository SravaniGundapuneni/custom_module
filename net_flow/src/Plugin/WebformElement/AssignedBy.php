...
/**
 * Provides a 'AssignedBy' element.
 *
 * @WebformElement(
 *   id = "assignedby",
 *   label = @Translation("AssignedBy element"),
 *   description = @Translation("Provides a webform element determing who is the assignee."),
 ...
 */
class AssignedBy extends WebformElementBase {
